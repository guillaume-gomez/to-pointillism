...
// tool function only used in full vanilla js function
// function distance([x1, y1, z1]: pixel, [x2, y2, z2]: pixel): number {
//   return Math.sqrt((x1 - x2) ** 2 + (y1 - y2) ** 2 + (z1 - z2) ** 2);
// }

// arrayDist full vanilla JS
